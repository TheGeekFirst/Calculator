...
self.screen = text(master, state='disabled', width=60, height=3, background="#fcfcec", foreground="#cb464e",
                   font=("times", 12, "bold"))
...
def createButton(self, val, write=True, width=7):
    return buttons(self.master, text=val, command=lambda: self.click(val, write),
                   width=width, background='#4b7f4', foreground='#fcfcec', font=("times", 20))
